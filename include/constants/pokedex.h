...
enum ObtainableDexOrder {
    ...
    // Alola
    OBTAINABLE_DEX_ROWLET,
    OBTAINABLE_DEX_DARTRIX,
    OBTAINABLE_DEX_DECIDUEYE,
    OBTAINABLE_DEX_LITTEN,
    OBTAINABLE_DEX_TORRACAT,
    OBTAINABLE_DEX_INCINEROAR,
    OBTAINABLE_DEX_POPPLIO,
    OBTAINABLE_DEX_BRIONNE,
    OBTAINABLE_DEX_PRIMARINA,
    OBTAINABLE_DEX_PIKIPEK,
    OBTAINABLE_DEX_TRUMBEAK,
    OBTAINABLE_DEX_TOUCANNON,
    OBTAINABLE_DEX_YUNGOOS,
    OBTAINABLE_DEX_GUMSHOOS,
    OBTAINABLE_DEX_GRUBBIN,
    OBTAINABLE_DEX_CHARJABUG,
    OBTAINABLE_DEX_VIKAVOLT,
    OBTAINABLE_DEX_CRABRAWLER,
    OBTAINABLE_DEX_CRABOMINABLE,
    OBTAINABLE_DEX_ORICORIO,
    OBTAINABLE_DEX_CUTIEFLY,
    OBTAINABLE_DEX_RIBOMBEE,
    OBTAINABLE_DEX_ROCKRUFF,
    OBTAINABLE_DEX_LYCANROC,
    OBTAINABLE_DEX_WISHIWASHI,
    OBTAINABLE_DEX_MAREANIE,
    OBTAINABLE_DEX_TOXAPEX,
    OBTAINABLE_DEX_MUDBRAY,
    OBTAINABLE_DEX_MUDSDALE,
    OBTAINABLE_DEX_DEWPIDER,
    OBTAINABLE_DEX_ARAQUANID,
    OBTAINABLE_DEX_FOMANTIS,
    OBTAINABLE_DEX_LURANTIS,
    OBTAINABLE_DEX_MORELULL,
    OBTAINABLE_DEX_SHIINOTIC,
    OBTAINABLE_DEX_SALANDIT,
    OBTAINABLE_DEX_SALAZZLE,
    OBTAINABLE_DEX_STUFFUL,
    OBTAINABLE_DEX_BEWEAR,
    OBTAINABLE_DEX_BOUNSWEET,
    OBTAINABLE_DEX_STEENEE,
    OBTAINABLE_DEX_TSAREENA,
    OBTAINABLE_DEX_COMFEY,
    OBTAINABLE_DEX_ORANGURU,
    OBTAINABLE_DEX_PASSIMIAN,
    OBTAINABLE_DEX_WIMPOD,
    OBTAINABLE_DEX_GOLISOPOD,
    OBTAINABLE_DEX_SANDYGAST,
    OBTAINABLE_DEX_PALOSSAND,
    OBTAINABLE_DEX_PYUKUMUKU,
    OBTAINABLE_DEX_TYPE_NULL,
    OBTAINABLE_DEX_SILVALLY,
    OBTAINABLE_DEX_MINIOR,
    OBTAINABLE_DEX_KOMALA,
    OBTAINABLE_DEX_TURTONATOR,
    OBTAINABLE_DEX_TOGEDEMARU,
    OBTAINABLE_DEX_MIMIKYU,
    OBTAINABLE_DEX_BRUXISH,
    OBTAINABLE_DEX_DRAMPA,
    OBTAINABLE_DEX_DHELMISE,
    OBTAINABLE_DEX_JANGMO_O,
    OBTAINABLE_DEX_HAKAMO_O,
    OBTAINABLE_DEX_KOMMO_O,
    ...
    OBTAINABLE_DEX_DECIDUEYE_HISUI,
