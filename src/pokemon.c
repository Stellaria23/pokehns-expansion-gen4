...
static const enum NationalDexOrder sObtainableToNationalOrder[OBTAINABLE_DEX_COUNT] =
{
    ...
    // Alola
    OBTAINABLE_TO_NATIONAL(ROWLET),
    OBTAINABLE_TO_NATIONAL(DARTRIX),
    OBTAINABLE_TO_NATIONAL(DECIDUEYE),
    OBTAINABLE_TO_NATIONAL(LITTEN),
    OBTAINABLE_TO_NATIONAL(TORRACAT),
    OBTAINABLE_TO_NATIONAL(INCINEROAR),
    OBTAINABLE_TO_NATIONAL(POPPLIO),
    OBTAINABLE_TO_NATIONAL(BRIONNE),
    OBTAINABLE_TO_NATIONAL(PRIMARINA),
    OBTAINABLE_TO_NATIONAL(PIKIPEK),
    OBTAINABLE_TO_NATIONAL(TRUMBEAK),
    OBTAINABLE_TO_NATIONAL(TOUCANNON),
    OBTAINABLE_TO_NATIONAL(YUNGOOS),
    OBTAINABLE_TO_NATIONAL(GUMSHOOS),
    OBTAINABLE_TO_NATIONAL(GRUBBIN),
    OBTAINABLE_TO_NATIONAL(CHARJABUG),
    OBTAINABLE_TO_NATIONAL(VIKAVOLT),
    OBTAINABLE_TO_NATIONAL(CRABRAWLER),
    OBTAINABLE_TO_NATIONAL(CRABOMINABLE),
    OBTAINABLE_TO_NATIONAL(ORICORIO),
    OBTAINABLE_TO_NATIONAL(CUTIEFLY),
    OBTAINABLE_TO_NATIONAL(RIBOMBEE),
    OBTAINABLE_TO_NATIONAL(ROCKRUFF),
    OBTAINABLE_TO_NATIONAL(LYCANROC),
    OBTAINABLE_TO_NATIONAL(WISHIWASHI),
    OBTAINABLE_TO_NATIONAL(MAREANIE),
    OBTAINABLE_TO_NATIONAL(TOXAPEX),
    OBTAINABLE_TO_NATIONAL(MUDBRAY),
    OBTAINABLE_TO_NATIONAL(MUDSDALE),
    OBTAINABLE_TO_NATIONAL(DEWPIDER),
    OBTAINABLE_TO_NATIONAL(ARAQUANID),
    OBTAINABLE_TO_NATIONAL(FOMANTIS),
    OBTAINABLE_TO_NATIONAL(LURANTIS),
    OBTAINABLE_TO_NATIONAL(MORELULL),
    OBTAINABLE_TO_NATIONAL(SHIINOTIC),
    OBTAINABLE_TO_NATIONAL(SALANDIT),
    OBTAINABLE_TO_NATIONAL(SALAZZLE),
    OBTAINABLE_TO_NATIONAL(STUFFUL),
    OBTAINABLE_TO_NATIONAL(BEWEAR),
    OBTAINABLE_TO_NATIONAL(BOUNSWEET),
    OBTAINABLE_TO_NATIONAL(STEENEE),
    OBTAINABLE_TO_NATIONAL(TSAREENA),
    OBTAINABLE_TO_NATIONAL(COMFEY),
    OBTAINABLE_TO_NATIONAL(ORANGURU),
    OBTAINABLE_TO_NATIONAL(PASSIMIAN),
    OBTAINABLE_TO_NATIONAL(WIMPOD),
    OBTAINABLE_TO_NATIONAL(GOLISOPOD),
    OBTAINABLE_TO_NATIONAL(SANDYGAST),
    OBTAINABLE_TO_NATIONAL(PALOSSAND),
    OBTAINABLE_TO_NATIONAL(PYUKUMUKU),
    OBTAINABLE_TO_NATIONAL(TYPE_NULL),
    OBTAINABLE_TO_NATIONAL(SILVALLY),
    OBTAINABLE_TO_NATIONAL(MINIOR),
    OBTAINABLE_TO_NATIONAL(KOMALA),
    OBTAINABLE_TO_NATIONAL(TURTONATOR),
    OBTAINABLE_TO_NATIONAL(TOGEDEMARU),
    OBTAINABLE_TO_NATIONAL(MIMIKYU),
    OBTAINABLE_TO_NATIONAL(BRUXISH),
    OBTAINABLE_TO_NATIONAL(DRAMPA),
    OBTAINABLE_TO_NATIONAL(DHELMISE),
    OBTAINABLE_TO_NATIONAL(JANGMO_O),
    OBTAINABLE_TO_NATIONAL(HAKAMO_O),
    OBTAINABLE_TO_NATIONAL(KOMMO_O),
    ...
    OBTAINABLE_TO_NATIONAL(DECIDUEYE_HISUI),
